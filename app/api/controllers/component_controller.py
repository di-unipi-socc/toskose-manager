...
# from app.api.services.component_service import ComponentService

# from app.api.models import ns_toskose_node as ns
# from app.api.models import lifecycle_operation_info
...
#     @ns.marshal_list_with(lifecycle_operation_info)
...
#         return ComponentService().manage_subprocess_log(
#             operation='clear_all',
#             node_id=node_id
#         )
...
#         log = ComponentService().manage_subprocess_log(
#             operation='read',
...
#         res = ComponentService().manage_subprocesses_log(
#             operation='clear',
#             node_id=node_id,
#             group_id=group_id,
#             subprocess_id=subprocess_id
